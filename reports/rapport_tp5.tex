...
Streamlit pour la démonstration interactive. Le système traite 638 947 entrées, fournit une
...
vectorielle indexee, un rapport technique et une interface de demonstration. La solution reste
...
demonstration web, les tests et d'eventuels clients externes consomment le meme contrat.
...
recurrences et temporelles utilisent des graphiques Plotly. L'onglet benchmarks complete la
demonstration avec les tailles disque, la latence des requetes, un score de coherence top-k et une
comparaison de plusieurs modeles Sentence-Transformers.
...
\begin{longtable}{p{0.37\linewidth}p{0.51\linewidth}}
\toprule
Endpoint & Fonction\\
\midrule
...
Le projet integre un module d'evaluation des performances afin de quantifier le comportement de la solution. Les
...
Une demonstration complete peut etre realisee en quatre temps. D'abord, l'evaluateur lance
PostgreSQL avec Docker Compose et execute le pipeline limite pour verifier le
...
\begin{figure}[p]
  ...
  \end{minipage}
\caption{Extraits de l'interface de demonstration.}
\end{figure}
